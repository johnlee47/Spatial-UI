        ...
        <div className="flex flex-col   h-screen bg-cover overflow-auto bg-gradient-to-r from-stone-50 via-purple-50 to-gray-50"  >
                   ...
                   <form >   
                        ...
                        <div className="flex relative items-center ">
                            ...
                            <input type="search" id="default-search" className="block p-4 md:pl-10 lg:pl-10 w-full text-sm md:lg:text-md lg:text-md  text-black  dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="555555555" required/>
